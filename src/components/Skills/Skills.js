      ...
      <div id="skills" className="min-h-screen bg-blue-100 p-10 sm:p-20 ">
        <div className="text-4xl">
          ...
          <div className="skill-wrapper justify-center flex-wrap flex gap-8 ">
            <img src={htmlImg} className="sm:w-24 sm:h-24  w-20 h-20" />
            <img src={cssImg} className="sm:w-24 sm:h-24 w-20 h-20" />
            <img src={jsImg} className="sm:w-24 sm:h-24 w-20 h-20" />
            <img src={jqueryImg} className="sm:w-24 sm:h-24 w-20 h-20" />
            <img src={bootstrapImg} className="sm:w-24 sm:h-24 w-20 h-20" />
            <img src={reactImg} className="sm:w-24 sm:h-24 w-20 h-20" />
