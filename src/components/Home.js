    ...
    <div>
      ...
      {/* <div id="about" className="home-wrapper h-screen flex space-between bg-blue-900"> */}
        <div className="left-wrapper w-full px-10 sm:px-30 sm:w-1/2 flex flex-col justify-left mt-20">
          ...
          <div style={{boxShadow : "rgb(95 219 255) 0px 0px 12px 2px", fontFamily: "Josefin Sans"}} className="text-l text-justify text-blue-100  mt-5 p-10 sm:p-3 rounded ">
        ...
        <div className="right-wrapper w-1/2 flex flex-wrap justify-center items-center mt-20 hidden sm:flex ">
          <div className="">
          <Lottie animationData={Frontend} loop={true} style={style} />
          </div>
